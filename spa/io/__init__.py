...
DATASET_MAP = {'s4_formula': ('7341_C1.csv', ',', False, '7341_C1 desc.txt', ['Stage 4 (4-7 years) formula'], 200),
               ...
               'olive_oil_ftir': ('olive_oil_ftir.csv', ',', True, 'olive_oil_ftir desc.txt', ["Greece", "Italy", "Portugal", "Spain"], .2),  
                ...
                'corn_nir': ('corn_nir.csv', ',', True, 'corn_nir desc.txt', ["Q1", "Q2", "Q3", "Q4", "Q5"], .2),  
                'coffee_ftir': ('coffee_ftir.csv', ',', True, 'coffee_ftir desc.txt', ["Arabica", "Robusta"], .2),  
                'fruit_purees_mir': ('fruit_purees_mir.csv', ',', True, 'fruit_purees_mir desc.txt', ["Strawberry (authentic)", "Non-strawberry"], .2),  
                'wine_ftir': ('wine_ftir.csv', ',', True, 'wine_ftir desc.txt', ["Cabernet Sauvignon", "Syrah"], .2),  
