...
def expand_dataset(X, y, d = 0.5, NX = 3, append = False):
    '''
    Parameters
    ----------
    ...
    append : if True, will return "original data + new data"; otherwise will return only "new data"
    '''
